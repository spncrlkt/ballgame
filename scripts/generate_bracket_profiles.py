...
Example:
  python3 scripts/generate_bracket_profiles.py \\
    ...
    parser.add_argument(
        "--db", required=True,
        help="Path to SQLite database with bracket results (REQUIRED, e.g., db/tournament_20260129_040643.db)"
    )
    parser.add_argument(
    ...
    print(f"Loading top performers from {args.db}...")
