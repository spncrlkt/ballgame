...
Online multiplayer is planned as a first-class feature. See **[docs/design/multiplayer_architecture.md](../design/multiplayer_architecture.md)** for:
...
*Archived to docs/planning: 2026-01-31*
